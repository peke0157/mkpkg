...
class PitchServer(Node):
    def __init__(self):
        ...
        # --- サービス(カウント用) ---
        self.srv_count = self.create_service(Trigger, '/count_pitch', self.check_pitch_callback)
        
        self.srv_reset = self.create_service(Trigger, '/reset_pitch', self.reset_callback)
